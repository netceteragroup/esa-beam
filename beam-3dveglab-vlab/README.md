...
as #2, but don't pass java the `-Dvlab.fakebeam=1` flag. In this case,
search for the method selftests() to see (or change) which tests will
be run in a GUI-less way (with log messages appearing on the console
