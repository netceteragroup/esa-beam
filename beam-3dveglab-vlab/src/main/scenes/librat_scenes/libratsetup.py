...
class cam:
	"""camera definition: librat camera defintion class, including methods to initialise camera name, result_image, result_integral_mode, result_integral, geom_azimuth, geom_zenith, geom_twist, geom_lookat (x, y, z), geom_idealArea (x, y), geom_boomlength, samplingCharacteristics_nPixels, samplingCharacteristics_rpp
	"""
